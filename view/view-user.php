            ...
            <div class="container-fluid p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-xl-10">
                        <form method="post" enctype="multipart/form-data" id="editUser" action="../controller/user_controller.php?status=edit_user">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-3">
                                                    ...
                                                    <select id="marital" name="marital" class="form-control">
                                                        ...
                                                        <option value="1" <?php if($userRow["user_marital"] == '1') echo 'selected="selected"'; ?>>Single</option>
                                                        <option value="2" <?php if($userRow["user_marital"] == '2') echo 'selected="selected"'; ?>>Married</option>
                                                    </select>
                                                </div>
                                                <div class="mb-3 col-md-3">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Private Info</h5>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6 error-placeholder">
                                                    ...
                                                    <input type="text" class="form-control required" id="salary" value="<?php echo $salary?>" name="salary" placeholder="Eg : 100 000" required>
                                                </div>
                                                <div class="mb-3 col-md-6 error-placeholder">
                                                    <label for="inputLastName" class="form-label">Travel Allowance</label>
                                                    <input id="travel_allowance" name="travel_allowance" type="text" value="<?php echo $travel_allowance?>" class="form-control required" placeholder="Eg : 2000" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control " id="bank_ac" value="<?php echo $bank_ac?>" name="bank_ac" placeholder="Account/Bank/Branch">
                                                </div>
                                            </div>
                                        <div class="row">
                                            <div class="mb-3 col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="mb-2 col-md-4">
                                                ...
                                                <input type="text" class="form-control " value="<?php echo $userRow["initial_annual"]?>" id="annual" name="annual">
                                            </div>
                                            <div class="mb-2 col-md-4">
                                                <label class="form-label">Number of Casual</label>
                                                <input type="text" class="form-control" value="<?php echo $userRow["initial_casual"]?>" id="casual" name="casual">
                                            </div>
                                            <div class="mb-2 col-md-4">
                                                <label class="form-label">Number of Sick</label>
                                                <input type="text" class="form-control" value="<?php echo $userRow["initial_sick"]?>" id="sick" name="sick">
                                            </div>
                                        </div>
                                        <br>
                                            <button type="submit" class="btn btn-primary">Save changes</button>
