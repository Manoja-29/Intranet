...
<div class="wrapper">
    ...
    <?php 
        ...
        $holiday_id=base64_decode($holiday_id);
        $holidayResult=$holidayObj->getParticularHoliday($holiday_id);
        ...
        <div class="row">
            <div class="col-5 col-lg-4 col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" id="editHolidays" action="../controller/holiday_leave_controller.php?status=edit_holiday_leave">
                            <div class="row">

                                <div class="mb-4 col-md-6">
                                    <label class="form-label">Holiday Name</label>
                                    <input type="hidden" class="form-control" value="<?php echo $holidayRow["holiday_id"]?>" id="holiday_id" name="holiday_id" placeholder="Holiday">
                                    <input type="text" class="form-control" value="<?php echo $holidayRow["holiday_name"]?>" id="holiday" name="holiday_desc" placeholder="Description">
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Date</label>
                                    <input type="date" class="form-control" value="<?php echo $holidayRow["date"]?>" id="holiday_date" name="holiday_date">
                                </div>
                            </div>
                                <?php
                                    $savedTypes = explode(',', $holidayRow['holiday_type']);//string to array
                                ?>
							    <label class="form-label">Holiday Type</label><br>
                                    <input type="checkbox" class="form-check-input" value='1' name="holiday_type[]" <?php if (in_array('1', $savedTypes)) echo 'checked'; ?>>
                                    <span class="form-check-label">Public</span>&nbsp;&nbsp;
                                    <input type="checkbox" class="form-check-input" value='2' name="holiday_type[]" <?php if (in_array('2', $savedTypes)) echo 'checked'; ?>>
                                    <span class="form-check-label">Mercantile </span>&nbsp;&nbsp;
                                    <input type="checkbox" class="form-check-input" value='3' name="holiday_type[]" <?php if (in_array('3', $savedTypes)) echo 'checked'; ?>>
                                    <span class="form-check-label">Bank </span>&nbsp;&nbsp;
                                    <input type="checkbox" class="form-check-input" value='4' name="holiday_type[]" <?php if (in_array('4', $savedTypes)) echo 'checked'; ?>>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="d-none d-xl-table-cell text-end">
                                                    ...
                                                    ?>
                                                    <a href="edit.php?holiday_id=<?php echo $holiday_id ?>" class="btn btn-light">&nbspEdit</a>
                                                </td>                                            
                                            </tr>
                                        <?php
                                                }
